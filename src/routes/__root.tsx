  ...
  head: () => ({
    meta: [
      ...
      { title: "OBB Store" },
      {
        name: "description",
        content:
          "OBB Store. Boutique premium au Sénégal : maillots, t-shirts, chaussures et parfums sélectionnés avec soin. Livraison rapide, commande WhatsApp.",
      },
      { name: "keywords", content: "OBB Store, maillots, t-shirts, chaussures, parfums, Sénégal, Dakar, luxe, premium, e-commerce, boutique en ligne" },
      { name: "author", content: "OBB Store" },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "OBB Store" },
      { property: "og:description", content: "Découvrez la sélection exclusive OBB Store. L'artisanat premium rencontre le style contemporain sénégalais." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "fr_FR" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "OBB Store" },
      { name: "twitter:description", content: "Découvrez la sélection exclusive OBB Store. L'artisanat premium rencontre le style contemporain sénégalais." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Daily+Grind&display=swap&family=Playfair+Display:ital,wght@0,600;0,700;1,600&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500&family=Mango+Grotesque:wght@400;500;600;700&display=swap",
      },
    ],
  }),
