        ...
        <div className="grid md:grid-cols-2 gap-8 p-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-mango font-bold mb-3 text-[#0A0A0A]">{product.name}</h2>
              <div className="flex items-center gap-3">
                <p className="font-price text-2xl font-bold text-[#1E40AF]">{formatPrice(product.price)}</p>
                {product.originalPrice && product.originalPrice > product.price && (
                  <>
                    <p className="font-mono text-sm text-[#0A0A0A]/40 line-through">{formatPrice(product.originalPrice)}</p>
