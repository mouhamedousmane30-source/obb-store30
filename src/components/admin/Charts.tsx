...
export function RevenueChart({ title = 'Chiffre d\'affaires', height = 320 }: ChartProps) {
  return (
...
export function OrdersChart({ title = 'Commandes', height = 320 }: ChartProps) {
  return (
    <div className="bg-card rounded-lg p-6 border border-foreground/8 col-span-2 lg:col-span-1">
      ...
      <ResponsiveContainer width="100%" height={height}>
        <BarChart data={monthlyRevenueData} margin={{ top: 5, right: 30, left: 0, bottom: 5 }}>
          <CartesianGrid strokeDasharray="3 3" stroke={colors.grid} />
          <XAxis 
            stroke={colors.primary}
            tick={{ fill: colors.primary, fontSize: 12 }}
...
export function CategoryChart({ title = 'Ventes par catégorie', height = 320 }: ChartProps) {
  return (
    <div className="bg-card rounded-lg p-6 border border-foreground/8 col-span-2">
      ...
      <ResponsiveContainer width="100%" height={height}>
        <BarChart data={categoryData} margin={{ top: 5, right: 30, left: 0, bottom: 5 }} layout="horizontal">
          <CartesianGrid strokeDasharray="3 3" stroke={colors.grid} />
          <XAxis 
            type="number"
            stroke={colors.primary}
